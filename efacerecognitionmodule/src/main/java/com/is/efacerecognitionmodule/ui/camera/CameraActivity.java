...
package com.is.efacerecognitionmodule.ui.camera;
...
public abstract class CameraActivity extends ToolbarActivity implements OnImageAvailableListener,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        btnSwitchCam.setOnClickListener(v -> onSwitchCameraClick());

    }

    private void bottomSheetInflateItems() {
    ...
    private void restartWith(Intent intent) {
        ...
        //overridePendingTransition(R.anim.animate_swipe_left_enter, R.anim.animate_swipe_right_exit);
    }
    ...
    public synchronized void onStart() {
        ...
        super.onStart();
        toolbar.setTitle(R.string.head_face_recognition);
    }
...
//        }
                ...
                LOGGER.i("Camera API lv2?: %s,idc:%s", useCamera2API,cameraId);
                return cameraId;
            }
    ...
    protected void fillBytes(@NotNull final Plane[] planes, final byte[][] yuvBytes) {
        // Because of the variable row stride it's not possible to know in
        // advance the actual necessary dimensions of the yuv planes.
        for (int i = 0; i < planes.length; ++i) {
            final ByteBuffer buffer = planes[i].getBuffer();
            if (yuvBytes[i] == null) {
                LOGGER.d("fillBytes(),Initializing buffer %d at size %d", i, buffer.capacity());
