...
import me.dev.is.mllibrary.feature.detector_face.ui.setting.CameraXLivePreviewPreferenceFragment;
import me.dev.is.mllibrary.feature.detector_face.ui.setting.CameraXSourceDemoPreferenceFragment;
import me.dev.is.mllibrary.feature.detector_face.ui.setting.LivePreviewPreferenceFragment;
import me.dev.is.mllibrary.feature.detector_face.ui.setting.StillImagePreferenceFragment;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      getFragmentManager().beginTransaction()
          .replace(R.id.settings_container, launchSource.prefFragmentClass.getDeclaredConstructor().newInstance())
          .commit();
    } catch (Exception e) {
