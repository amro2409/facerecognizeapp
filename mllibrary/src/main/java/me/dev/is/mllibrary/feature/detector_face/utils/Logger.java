package me.dev.is.mllibrary.feature.detector_face.utils;/* Copyright 2015 The TensorFlow Authors. All Rights Reserved.
...
public final class Logger {
    private static final String DEFAULT_TAG = "ml-library";
    ...
    private String toMessage(final String format, final Object... args) {
        return messagePrefix + arrow + (args.length > 0 ? String.format(format, args) : format);
    }
    ...
    public String getUnsatisfiedLinkError(String nameMethod){
        return "Native "+nameMethod+" implementation not found, falling back to Java implementation";
    }
}
